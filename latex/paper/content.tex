...
\title{Automatic Translation of Logic Grid Puzzles into a Typed Logic}
%
%
...
\input{ch_lexicon}
\input{ch_grammar}
% \input{ch_framework_conclusion}

\input{ch_types}
\input{ch_specification}
\input{ch_evaluation}
\input{ch_earlier}
\input{ch_conclusion}
...
% \onecolumn
% \appendix[A grammar for logigrams]
% \input{app_grammar}
