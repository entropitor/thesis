...
Verder is het ook mogelijk om een boom op te bouwen tijdens het parsen. Grammatica~\ref{dcg:treeBuilding} is zo'n grammatica. Bij het parsen van \example{ik zie hem} krijgen we nu volgende boom als waarde voor het eerste argument van \texttt{s}.
